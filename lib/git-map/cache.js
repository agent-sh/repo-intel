 ...
 *
 * Handles load/save of git-map.json in the platform-aware state directory.
...
const MAP_FILENAME = 'git-map.json';
...
/**
 * Get the path to git-map.json for a given repository root.
 *
 * @param {string} basePath - Repository root
 * @returns {string} Absolute path to git-map.json
 */
...
/**
 * Load git-map.json from the platform state directory.
 *
 * @param {string} basePath - Repository root
...
/**
 * Check whether a cached git-map.json exists for the given repository.
 *
 * @param {string} basePath - Repository root
 * @returns {boolean}
 */
