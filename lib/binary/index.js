...
// (agnix measured at ~21 MB). Node's execFile default maxBuffer is 1 MB, which
...
function getBinaryPath() {
  // Explicit override (a full path to an agent-analyzer binary) for callers
  // that ship/pin their own — e.g. CI, a vendored binary, or multi-version use.
  if (process.env.AGENT_ANALYZER_BIN) return process.env.AGENT_ANALYZER_BIN;
